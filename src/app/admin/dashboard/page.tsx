...
export default function AdminDashboard() {
  ...
  const handleExport = (type: 'csv' | 'xlsx' | 'pdf') => {
    try {
      ...
      if (type === 'xlsx') exportToXLSX(filteredComplaints, dummyAdmin);
      if (type === 'pdf') exportToPDF(filteredComplaints, dummyAdmin);
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 text-white">
      ...
      <div className="flex bg-black/40 border border-white/10 p-6 rounded-xl backdrop-blur-sm justify-between items-center">
        <div className="space-y-1">
          ...
          <p className="text-gray-400">System overview and complete complaint management.</p>
        </div>
            ...
            <DialogContent className="bg-[#0A1116] border-white/10 text-white sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription className="text-gray-400">
                  Download all complaints data across the system.
                </DialogDescription>
              </DialogHeader>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
             <h2 className="text-xl font-semibold text-gray-200">System Activity</h2>
        </div>
      ...
      <Dialog open={!!selectedComplaint} onOpenChange={(open) => !open && setSelectedComplaint(null)}>
        <DialogContent className="bg-[#0A1116] border-white/10 text-white sm:max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-mono text-teal-400">{selectedComplaint?.complaintId}</DialogTitle>
            <DialogDescription className="text-gray-400">
              Manage complete investigation details.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-6 space-y-6">
            ...
            {/* Editor reused for admin powers */}
            {selectedComplaint && (
              <ComplaintEditor
